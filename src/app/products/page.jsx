...
export default function ProductsPage() {
  ...
  return (
    <div className="bg-white overflow-hidden relative min-h-screen" ref={containerRef}>
      ...
      {/* <section className="py-20 bg-white relative z-20"> ...Coverage & Calculation... </section> */}
      {/* <section className="py-20 bg-white relative z-20"> ...Application of Emulsion Paints... </section> */}
      {/* <section className="my-20 relative z-30"> ...Health & Safety Information... </section> */}

      {/* --- REPLACE with this info box --- */}
      <section className="py-20 bg-blue-50 border-y border-blue-100">
        <div className="max-w-2xl mx-auto text-center px-6">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
            Need Technical Guides or Safety Info?
          </h2>
          <p className="mb-6 text-blue-700">
            Find detailed coverage calculators, application tutorials, and health & safety resources in our Resource Center.
          </p>
          <a
            href="/resources"
            className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
          >
